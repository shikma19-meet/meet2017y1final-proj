...
##    if x_pos == RIGHT_EDGE and x_pos == LEFT_EDGE and y_pos == UP_EDGE and y_pos == DOWN_EDGE:
##        time.sleep(10)
##    if not x_pos == RIGHT_EDGE and x_pos == LEFT_EDGE and y_pos == UP_EDGE and y_pos == DOWN_EDGE:
